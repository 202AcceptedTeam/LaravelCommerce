...
class CartController extends Controller
{
    ...
    public function getCourier2(Request $request,$origin,$destination,$weight,$courier)
    {
        $this->validate($request, [
    ...
    public function getCourier(Request $request,$courier)
    {
        $this->validate($request, [
            'destination' => 'required',
            'weight' => 'required|integer'
